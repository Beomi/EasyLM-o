...
HASH='f44e2561b0434e19aa129e83afd531eb'
...
--load_dataset_state=gs://llama-2-ko/open-llama-2-ko-7b-subword/$HASH/dataset.pkl \
--load_checkpoint=trainstate::gs://llama-2-ko/open-llama-2-ko-7b-subword/$HASH/streaming_train_state \
--mesh_dim=4,-1,1 \
--dtype=bf16 \
--total_steps=30001 \
--log_freq=50 \
